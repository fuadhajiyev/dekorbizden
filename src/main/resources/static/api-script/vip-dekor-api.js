...
const allfotozonalar = 'http://localhost:8080/api/1.0/alldekorlar?type='+'standart';
const getAlldekorlar = 'http://localhost:8080/api/1.0/alldekorlar?type='+typename;
const page_url = `http://localhost:8080/api/1.0/dekorlar?page=`;

let   count = 0;

var content = document.getElementById("vip-content");
