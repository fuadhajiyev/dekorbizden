...
const url_ItemCode = 'http://localhost:8080/api/1.0/dekorlar/';
const getAlldekorlar = 'http://localhost:8080/api/1.0/allxinadekorlar?type='+typename;
const page_url = `http://localhost:8080/api/1.0/dekorlar?page=`;
...
var getAll = function (pageCount = 0) {
  ...
  .then(data => {
    ...
    users = data.map(user => {
      ...
      btn.innerHTML =  `       <form  action="../../magaza/standart/xina-item-details.html" class="thumb-link" method="get">
    ...
    .then(data => {
      ...
      <div class="product-inner tooltip-top tooltip-all-top">
          ...
          <div>
              ...
              <form  action="../magaza/standart/xina-item-details.html" class="thumb-link" method="get">
