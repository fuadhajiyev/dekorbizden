...
const getAlldekorlar = 'http://localhost:8080/api/1.0/allfotozonalar';
...
var getAll = function (pageCount = 0) {
  ...
  .then(data => {
    ...
    users = data.map(user => {
      ...
      btn.innerHTML =  `       <form  action="../magaza/standart/fotozona-item-details.html" class="thumb-link" method="get">
